...
import { useRegister } from '@/hooks/data/use-auth';
...
export default function SignUpModal({ open, setOpenAction: setIsModalOpen, email, password }: Props) {
  ...
  const register = useRegister(email, password, setIsModalOpen);
